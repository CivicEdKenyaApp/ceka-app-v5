...
const translations: Record<string, Record<Language, string>> = {
  ...
  'Signing in...': { en: 'Signing in...', sw: 'Inaingia...', ksl: 'Signing in...', br: '⠎⠊⠛⠝⠊⠝⠛ ⠊⠝...' },
  ...
  'Sign in to access all CEKA features': { en: 'Sign in to access all CEKA features', sw: 'Ingia ili kupata huduma zote za CEKA', ksl: 'Sign in to access all CEKA features', br: '⠎⠊⠛⠝ ⠊⠝ ⠞⠕ ⠁⠉⠉⠑⠎⠎ ⠁⠇⠇ ⠉⠑⠅⠁ ⠋⠑⠁⠞⠥⠗⠑⠎' },
