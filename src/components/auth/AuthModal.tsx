...
return ( <Dialog open={open} onOpenChange={onOpenChange}> <DialogContent className="sm:max-w-md backdrop-blur-lg bg-white/90 shadow-lg border border-primary/10 relative overflow-hidden z-50">
{/\* Kenya-themed color gradient overlay \*/} <div className="absolute inset-0 bg-gradient-to-br from-[#006600]/10 via-[#EEEEEE]/5 to-[#BB1600]/10 pointer-events-none z-0"></div>
